...
/**
 * the display rotation response * @param displayRotation the display rotation enum value*/
data class DisplayRotationResponse (    /* the display rotation enum value */    val displayRotation: DisplayRotationEnum? = null
) {
}
